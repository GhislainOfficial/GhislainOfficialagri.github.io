...
<html>
    <head>
        ...
        <title>All Categories Store</title>
        <!--Link to CSS-->
    ...
    <body>
        ...
        <section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">Bolo</span>
                    <img class="shop-item-image" src="pictures/bolo.png">
                    <div class="shop-item-details">
                        <span class="shop-item-price">₱550.00</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                    </div>
                </div>
                <div class="shop-item">
                    <span class="shop-item-title">Crowbar</span>
                    <img class="shop-item-image" src="pictures/crowbar.png">
                    <div class="shop-item-details">
                        <span class="shop-item-price">₱413.44</span>
                        <button class="btn btn-primary shop-item-button"type="button">ADD TO CART</button>
                    </div>
                </div>
                <div class="shop-item">
                    <span class="shop-item-title">Pick Mattock</span>
                    <img class="shop-item-image" src="pictures/pickmattock.png">
                    <div class="shop-item-details">
                        <span class="shop-item-price">₱420.00</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                    </div>
                </div>
                <div class="shop-item">
                    <span class="shop-item-title">Prunning-Shears</span>
                    <img class="shop-item-image" src="pictures/prunning-shears.png">
                    <div class="shop-item-details">
                        <span class="shop-item-price">₱239.00</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                    </div>
                </div>
                <div class="shop-item">
                    <span class="shop-item-title">Knife</span>
                    <img class="shop-item-image" src="pictures/knife.png">
                    <div class="shop-item-details">
                        <span class="shop-item-price">₱412.25</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                    </div>
                </div>
                <div class="shop-item">
                    <span class="shop-item-title">Shovel</span>
                    <img class="shop-item-image" src="pictures/shovel.png">
                    <div class="shop-item-details">
                        <span class="shop-item-price">₱439.45</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                    </div>
                </div>
            </header>
            ...
            <section class="container content-section">
                ...
                <div class="shop-items">
                    ...
                    <section class="container content-section">
                        <br>
                        <h2 class="section-header">Feeds</h2>
                        <div class="shop-items">
                            <div class="shop-item">
                                <span class="shop-item-title">Organic Poultry Feeds</span>
                                <img class="shop-item-image" src="pictures/Organic Poultry Feeds.png">
                                <div class="shop-item-details">
                                    <span class="shop-item-price">₱950.00</span>
                                    <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                                </div>
                            </div>
                            <div class="shop-item">
                                <span class="shop-item-title">Aqua Nourish Feeds</span>
                                <img class="shop-item-image" src="pictures/Aqua Nourish Feeds.png">
                                <div class="shop-item-details">
                                    <span class="shop-item-price">₱1100.25</span>
                                    <button class="btn btn-primary shop-item-button"type="button">ADD TO CART</button>
                                </div>
                            </div>
                            <div class="shop-item">
                                <span class="shop-item-title">Organic Cattle Feeds</span>
                                <img class="shop-item-image" src="pictures/Organic Cattle Feeds.png">
                                <div class="shop-item-details">
                            ...
                            <div class="shop-item">
                                <span class="shop-item-title">Egg Layer Feeds</span>
                                <img class="shop-item-image" src="pictures/Egg Layer Feeds.png">
                                <div class="shop-item-details">
                                    <span class="shop-item-price">₱1100.00</span>
                                    <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                                </div>
                            </div>
                            <!--Seedlings-->
